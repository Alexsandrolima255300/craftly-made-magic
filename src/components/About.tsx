    ...
    <section className="py-24 px-6">
      <div className="max-w-3xl mx-auto text-center space-y-8">
        <p className="font-body text-lg md:text-xl leading-relaxed text-foreground/85">
          Entramos no mercado com o propósito de proporcionar aos nossos parceiros e clientes
          não apenas um projeto, mas sim um <span className="text-primary font-semibold">conceito</span>, uma{" "}
          <span className="text-primary font-semibold">experiência</span>.
        </p>
        <p className="font-body text-lg md:text-xl leading-relaxed text-foreground/85">
          Entregamos uma decoração de conceito smart, clean, alternativa e personalizada,
          completamente <span className="text-accent font-semibold">feita à mão</span>.
        </p>
        <div className="pt-6">
          <a
